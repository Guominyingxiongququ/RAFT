...
from .mask import (bbox2mask, brush_stroke_mask, get_irregular_mask,
                              random_bbox)
...
@PIPELINES.register_module()
class LoadRawImageFromFileList(LoadImageFromFile):
    """Load Raw image from file list.
